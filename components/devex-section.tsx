...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the Agentix SDK" },
      { type: "command", text: "npm install @agentix/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx agentix init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@agentix/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@agentix/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to Agentix Cloud" },
      { type: "command", text: "agentix deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://agents.agentix.dev/researcher" },
    ],
  },
]
