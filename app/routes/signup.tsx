...
export default function SignupRoute() {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    if (error) {
      ...
      setIsSuccess(true);
      setMessage('Sign-up link sent! Check your email to complete registration.');
    }
  }
